...
AUTHORIZED_USERS = [
    "pallerlavijay315@gmail.com",  # Your email - now authorized!
    "your.email@gmail.com",        # Replace with other authorized emails
    "palle@example.com",           # Replace with authorized user emails
            ...
            <html>
                ...
                <body>
                    <div class="error-container">
                        ...
                        <p>Sorry, you don't have permission to access this DSA Dashboard.</p>
                        <p>Contact the administrator to get access.</p>
